...
internal class SetterSpecificityListAdHoc : SetterSpecificityListAdHoc<object>
{}

/// <summary>
/// Stores values for a property with different specificities.
/// </summary>
internal class SetterSpecificityListAdHoc<T> where T : class
{
    ...
    public SetterSpecificityListAdHoc()
    {
	    _keys = Array.Empty<SetterSpecificity>();
	    _values = Array.Empty<T>();
    }

    public SetterSpecificityListAdHoc(int initialCapacity)
    {
